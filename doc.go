...
// BUG(you): Needs testing 'in the wild'

// TODO(you): Better documentation
// TODO(you): Ability to use `Content-Disposition`
// TODO(you): Full config parsing and error checking at load
// TODO(you): Test suite
